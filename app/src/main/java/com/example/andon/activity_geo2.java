...
public class activity_geo2 extends AppCompatActivity implements View.OnClickListener {
    Button[] buttons;
    String[] button_ids = new String[] {"GEO2CV1","GEO2CV2","GEO2CV3","GEO2CV4","GEO2CV5","GEO2CV6","GEO2CV7","GEO2CV8","GEO2CV9","GEO2CV10"};
    @Override
